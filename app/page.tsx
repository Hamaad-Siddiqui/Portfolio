 ...
 return (
  <div className='flex flex-col'>
   <div className='flex flex-col max-w-[42rem] gap-1 mt-4'>
    ...
    />
    <h1 className='font-semibold text-4xl text-primary dark:text-darkPrimary'>
     Hamaad Siddiqui
    </h1>
    <p className='text-primary dark:text-darkPrimary mt-4'>
     Full-Stack Developer building intuitive and efficient applications using
     React / Next.js & Flutter. Passionate about staying current with industry
     developments and continuously expanding my skillset to deliver innovative
     solutions.
    </p>
    <p className='text-primary dark:text-darkPrimary mt-4'>
     I am always interested in new projects, tech, and opportunities. If you
     would like to connect we can schedule a call, you can also reach out via
     the links below.
    </p>
   </div>
